...
%% Initialize
% Vehicle Parameters  SET TO CORRECT VALUES
Isp = 225; % [s]
...
m_dry = 2100; % [kg] <- Delete for Astra
m_wet = 1150; % [kg] <- Delete for Astra
m_0 = m_dry; % [kg] <- Fix in General Model
...
mass_constraint = {1:N, @(t, x, u, p) m_dry - x(14)}; % <- not needed for Astra
