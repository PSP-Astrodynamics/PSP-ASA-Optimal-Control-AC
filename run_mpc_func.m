...
function [x_hist, u_hist, x_error_hist] = run_mpc_func(Isp_actual, I_actual, v_disturbance, w_disturbance)
arguments
    Isp_actual = 220;
...
% Disturbances
disturbances = @(t, x) [zeros([3, 1]); v_disturbance; zeros([4, 1]); w_disturbance; 0];
...
x_hist = x_0;
u_hist = u_0;
x_error_hist = x_0 - ref.x_ref_sol(:, 1);
...
while t_k < max_time
    ...
    x_error_hist = [x_error_hist; x_error];
end
